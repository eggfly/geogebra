...
public enum Language {
	...
	// order
	Afrikaans(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
			false, "af", "Afrikaans", Script.LATIN),

	Albanian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"sq", "Albanian / Gjuha Shqipe", Script.LATIN, ','),

	Amharic(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null,
			"\u134b\u12ed\u120d", false, "am",
			"Amharic / \u0041\u006d\u0061\u0072\u0259\u00f1\u00f1\u0061",
			Script.ETHIOPIAN),

	Arabic(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"ar",
	...
	Arabic_Morocco(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
			true, "arMA", "ar",
	...
	Arabic_Tunisia(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
			true, "arTN", "ar",
	...
	Arabic_Syria(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
			false, "arSY", "ar",
	...
	Armenian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, "\u0570",
			true, "hy",
			"Armenian / \u0540\u0561\u0575\u0565\u0580\u0565\u0576",
			Script.ARMENIAN, ','),

	Azerbaijani(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
			false, "az", "Azerbaijani", Script.LATIN, ','),

	Basque(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "eu", "eu",
			"Basque / Euskara", Script.LATIN, ','),

	Bengali(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "bn",
			"Basque / Euskara", Script.LATIN),

	Bosnian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "bs",
			"Bosnian / \u0431\u043E\u0441\u0430\u043D\u0441\u043A\u0438",
			Script.LATIN),

	Bulgarian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "bg",
			"Bulgarian / \u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438"
					+ " \u0435\u0437\u0438\u043A",
			Script.CYRILLIC, ','),

	Catalan(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "ca", "ca",
			"Catalan / Catal\u00E0", Script.LATIN, ','),

	Valencian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "caXV", "ca",
			"Catalan / Catal\u00E0 (Valenci\u00E0)", Script.LATIN, ','),

	Chinese_Simplified(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null,
			"\u984F", true, "zhCN", "zh",
			"Chinese Simplified / \u7B80\u4F53\u4E2D\u6587", Script.HANS, ','),

	Chinese_Traditional(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null,
			"\u984F", true, "zhTW", "zh",
			"Chinese Traditional / \u7E41\u9AD4\u4E2D\u6587", Script.HANT, ','),

	Croatian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "hr", 
			"Croatian / Hrvatska", Script.LATIN, ','),

	Czech(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "cs",
			"Czech / \u010Ce\u0161tina", Script.LATIN, ','),

	Danish(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"da", "Danish / Dansk", Script.LATIN, ','),

	Dutch_Belgium(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "nl", "nl_BE",
			"Dutch / Nederlands (Belgi\u00eb)", Script.LATIN, ','),

	Dutch(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "nlNL", "nl",
			"Dutch / Nederlands (Nederland)", Script.LATIN, ','),

	English_US(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_DOLLAR + "" + "", null, true, "en", 
			"English (US)", Script.LATIN),

	English_UK(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_POUND + "", null, true, "enGB", "en",
			"English (UK)", Script.LATIN, '.'),

	English_Australia(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_DOLLAR + "", null, true, "enAU", "en",
			"English (Australia)", Script.LATIN, '.'),

	Esperanto(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
			false, "eo", "Esperanto", Script.LATIN),

	Estonian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "et",
			"Estonian / Eesti keel", Script.LATIN, ','),

	Filipino(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"tl", "fil", "Filipino", Script.LATIN, ','), //TODO separator?

	Finnish(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "fi",
			"Finnish / Suomi", Script.LATIN, ','),

	French(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "fr",
			"French / Fran\u00E7ais", Script.LATIN, ','),

	Galician(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "gl", "gl",
			"Galician / Galego", Script.LATIN, ','),

	Georgian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, "\u10d8",
			true, "ka",
			"Georgian / \u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8 \u10D4\u10DC\u10D0",
			Script.GEORGIAN, ','),

	// German must be before German_Austria
	German(euclideanStyleConstants.RIGHT_ANGLE_STYLE_DOT,
			Unicode.CURRENCY_EURO + "", null, true, "de",
			"German / Deutsch", Script.LATIN, ','),

	German_Austria(euclideanStyleConstants.RIGHT_ANGLE_STYLE_DOT,
			Unicode.CURRENCY_EURO + "", null, true, "deAT", "de",
			"German / Deutsch (\u00D6sterreich)", Script.LATIN, ','),

	Greek(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "el",
			"Greek / \u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC",
			Script.GREEK, ','),

	Hebrew(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_SHEKEL + "", "\u05d9", true, "iw", "he",
			"Hebrew / \u05E2\u05B4\u05D1\u05B0\u05E8\u05B4\u05D9\u05EA",
			Script.HEBREW, '.'),

	Hindi(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_INDIAN_RUPEE + "", "\u0be7", true, "hi",
			"Hindi / \u092E\u093E\u0928\u0915 \u0939\u093F\u0928\u094D\u0926\u0940",
			Script.DEVANGARI),

	Hungarian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_DOT,
			Unicode.CURRENCY_EURO + "", null, true, "hu", 
			"Hungarian / Magyar", Script.LATIN, ','),

	Icelandic(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
	 ...
	 * 
	 */
	Indonesian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
			true, "in", "id", "Indonesian / Bahasa Indonesia",
			Script.LATIN, ','),

	Italian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "it", 
			"Italian / Italiano", Script.LATIN, ','),

	// Irish(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
	// false,
	// "ga",
	// "ga", "Irish / Gaeilge", Script.LATIN),

	Japanese(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_YEN + "", "\uff9d", true, "ja",
			"Japanese / \u65E5\u672C\u8A9E", Script.JAPANESE),

	Kannada(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, "\u1103",
			true, "kn", "Kannada", Script.KANNADA),

	Kazakh(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"kk",
			"Kazakh / \u049A\u0430\u0437\u0430\u049B \u0442\u0456\u043B\u0456",
			Script.CYRILLIC, ','),

	Khmer(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"km",
			"Khmer",
			Script.LATIN),

	Korean(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_WON + "", "\u1103", true, "ko",
			"Korean / \uD55C\uAD6D\uB9D0", Script.KOREAN),

	Latvian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "lv",
			"Latvian / Latvie\u0161u valoda", Script.LATIN, ','),

	Lithuanian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "lt",
			"Lithuanian / Lietuvi\u0173 kalba", Script.LATIN, ','),

	Malay(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"ms", "Malay / Bahasa Malaysia", Script.LATIN),

	Malayalam(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, "\u0D2E",
			false, "ml",
			"Malayalam / \u0D2E\u0D32\u0D2F\u0D3E\u0D33\u0D02",
			Script.MALAYALAM),

	Macedonian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "mk",
			"Macedonian / \u041C\u0430\u043A\u0435\u0434\u043E\u043D\u0441\u043A\u0438"
					+ " \u0458\u0430\u0437\u0438\u043A",
			Script.CYRILLIC, ','),

	Marathi(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, "\u092e", null,
			false, "mr", "Marathi / \u092E\u0930\u093E\u0920\u0940",
			Script.DEVANGARI),

	Mongolian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_TUGHRIK + "", null, true, "mn",
			"Mongolian / \u041C\u043E\u043D\u0433\u043E\u043B \u0445\u044D\u043B",
			Script.MONG, ','),

	Nepalese(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_RUPEE + "", "\u0947", true, "ne",
			"Nepalese / \u0928\u0947\u092A\u093E\u0932\u0940",
			Script.DEVANGARI),

	Norwegian_Bokmal(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null,
			null, true, "noNO", "nb", "Norwegian / Bokm\u00e5l",
			Script.LATIN, ','),

	Norwegian_Nynorsk(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null,
			null, true, "noNONY", "nn", "Norwegian / Nynorsk",
			Script.LATIN, ','),

	Persian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"fa", "Persian / \u0641\u0627\u0631\u0633\u06CC",
			Script.ARABIC),

	Polish(euclideanStyleConstants.RIGHT_ANGLE_STYLE_DOT,
	...
	Portuguese_Brazil(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null,
			null, true, "pt", "Portuguese / Portugu\u00EAs (Brasil)",
			Script.LATIN, ','),

	Portuguese_Portugal(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "ptPT", "pt",
			"Portuguese / Portugu\u00EAs (Portugal)", Script.LATIN, ','),

	Romanian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "ro",
			"Romanian /  Rom\u00E2n\u0103", Script.LATIN),

	Russian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, "\u0439",
			true, "ru",
			"Russian / \u0420\u0443\u0441\u0441\u043A\u0438\u0439 \u044F\u0437\u044B\u043A",
			Script.CYRILLIC, ','),

	Sinhala(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_RUPEE + "", "\u0d9a", true, "si",
			"Sinhala / \u0DC3\u0DD2\u0D82\u0DC4\u0DBD", Script.SINHALA),

	Serbian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "sr",
			"Serbian / \u0441\u0440\u043F\u0441\u043A\u0438", Script.LATIN, ','),

	Slovak(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "sk",
			"Slovak / Slovensk\u00FD jazyk", Script.LATIN),

	Slovenian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "sl",
			"Slovenian / Sloven\u0161\u010Dina", Script.LATIN, ','),

	Spanish(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_DOLLAR + "", null, true, "es",
			"Spanish / Espa\u00F1ol", Script.LATIN, ','),

	Spanish_UY(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_DOLLAR + "", null, true, "esUY", "es",
			"Spanish / Espa\u00F1ol (Uruguay)", Script.LATIN, ','),

	Spanish_ES(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "esES", "es",
			"Spanish / Espa\u00F1ol (Espa\u00F1a)", Script.LATIN, ','),

	Swedish(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "sv", 
			"Swedish / Svenska", Script.LATIN, ','),

	Tamil(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_RUPEE + "", "\u0be7", true, "ta",
			"Tamil / \u0BA4\u0BAE\u0BBF\u0BB4\u0BCD", Script.TAMIL),

	Tajik(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, false,
			"tg", "Tajik", Script.LATIN),

	// Telugu("\u0C24", false, "te","te",
	// "Telugu / \u0C24\u0C46\u0C32\u0C41\u0C17\u0C41", Country.India),

	Thai(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_BAHT + "", null, true, "th",
			"Thai / \u0E20\u0E32\u0E29\u0E32\u0E44\u0E17\u0E22", Script.THAI),

	Turkish(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_EURO + "", null, true, "tr",
			"Turkish / T\u00FCrk\u00E7e", Script.LATIN),

	Ukrainian(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null,
			true, "uk",
			"Ukrainian / \u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430"
					+ " \u043C\u043E\u0432\u0430",
			Script.CYRILLIC, ','),

	Uyghur(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"ug", "Uyghur", Script.ARABIC),

	Uzbek(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"uz", "Uzbek", Script.CYRILLIC, ','),

	Vietnamese(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
			Unicode.CURRENCY_DONG + "", null, true, "vi",
			"Vietnamese / Ti\u1EBFng Vi\u1EC7t", Script.LATIN, ','),

	Welsh(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
			"cy", "cy", "Welsh / Cymraeg", Script.LATIN, '.'),

	Xhosa(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, null, null, true,
	 ...
	 * 
	 */
	Yiddish(euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE,
	...
	private int rightAngleStyle = euclideanStyleConstants.RIGHT_ANGLE_STYLE_SQUARE;
